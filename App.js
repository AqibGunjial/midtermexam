...
const LoginScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Username" placeholderTextColor="#A0D9B4" value={username} onChangeText={setUsername} style={styles.input} />
      <TextInput placeholder="Password" placeholderTextColor="#A0D9B4" value={password} onChangeText={setPassword} secureTextEntry style={styles.input} />
...
const JobListScreen = ({ navigation }) => {
  ...
  if (loading) {
    return <ActivityIndicator size="large" color="#2E8B57" style={{ marginTop: 20 }} />;
  }
...
const JobDetailScreen = ({ route }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button title="Apply Now" onPress={() => alert('Application link: ' + (job.apply_link || 'Not provided'))} color="#2E8B57" />
    </View>
  );
};
...
export default function App() {
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerStyle: { backgroundColor: '#000' }, headerTintColor: '#2E8B57' }}>
